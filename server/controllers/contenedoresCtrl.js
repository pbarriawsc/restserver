...
exports.list = (req, res) => {
    client.query('SELECT c.*,(SELECT count(id) FROM public.contenedor_historial WHERE fk_contenedor=c.id)::integer AS historial FROM public.contenedor c ORDER BY id DESC', "", function (err, result) {
        if (err) {
            console.log(err);
